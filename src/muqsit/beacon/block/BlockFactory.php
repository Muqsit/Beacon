...
final class BlockFactory{
	...
	public static function init() : void{
		...
		VanillaBlockFactory::getInstance()->register(new Beacon(new BlockIdentifier($parent_id_info->getBlockId(), $parent_id_info->getVariant(), $parent_id_info->getItemId(), BeaconTile::class), $parent->getName(), $parent->getBreakInfo()), true);
