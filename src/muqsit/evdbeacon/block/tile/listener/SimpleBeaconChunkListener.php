...
final class SimpleBeaconChunkListener implements BeaconChunkListener {
    ...
    public function onChunkChanged(
        int $chunkX,
        int $chunkZ,
        Chunk $chunk
    ): void {
    ...
    public function onChunkUnloaded(
        int $chunkX,
        int $chunkZ,
        Chunk $chunk
    ): void {
    ...
    public function onChunkPopulated(
        int $chunkX,
        int $chunkZ,
        Chunk $chunk
    ): void {
    ...
    public function onBlockChanged(Vector3 $block): void {
        if (
            // TODO: Check for blocks inside 3D pyramidal volume instead of a cubical, possibly by caching XYZ offsets relative to beacon's position
